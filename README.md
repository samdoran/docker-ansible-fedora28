...
[![Container Repository on Quay](https://quay.io/repository/samdoran/fedora28-ansible/status "Container Repository on Quay")](https://quay.io/repository/samdoran/fedora28-ansible)
...
To build your own version of this container, run:
    ...
    podman build -t fedora28-ansible -f Containerfile .
...
platforms:
  - name: role-test
    image: "quay.io/samdoran/${MOLECULE_DISTRIBUTION:-fedora28}-ansible:latest"
